    ...
    <div class="span12">
                ...
                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr >
                            ...
                            <td > Height of lowest cloud cover </td>S
        ...
        <?php }
                ...
                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        <td class="rotate">   <div><span>Grass minimum temperature</span></div></td>
                        <td class="rotate"> <div><span>Character & intensity of precipitation</span></div></td>
                        <td class="rotate"><div><span>Beginning or end of precipitation</span></div></td>
                        <td class="rotate"><div><span>Maximum temperature</span></div></td>
                        <td class="rotate"> <div><span>Minimum temperature</span></div> </td>
                        <td class="rotate"><div><span>Amount of evaporation</span></div></td>

                        <td class="rotate"><div><span>Indicator of  type of instrument</span></div></td>
                        <td class="rotate"><div><span> Duration of sunshine</span></div></td>
                        <td class="rotate"><div><span>Sign of pressure change</span></div></td>
                        <td class="rotate"> <div><span>Pressure change in 24 hours </span></div></td>
                        <td class="rotate"><div><span> Amount of precipitation</span></div></td>

                        <td class="rotate"><div><span> Duration period of precipitation</span></div></td>
                        <td class="rotate"><div><span>Amount of individual cloud layer</span></div> </td>
                        <td class="rotate"><div><span>Genus of cloud </span></div> </td>
                        <td class="rotate"><div><span>Height of base cloud layer or mass</span></div></td>
                        ...
                        <td class="rotate" colspan="2"><div ><span><br><br> <br>Supplementary information<br>9 11 ff highest gust <br>9 12 ff highest mean wind speed<br>9 43CL DP movement of C clouds</span></div></td>
        ...
        <?php }
                        ...
                        <tr>
                            ...
                            <td colspan="3"> <input type="text" id="supplementary" name="supplementary"   /></td>
                        </tr>
