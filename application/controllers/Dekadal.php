        ...
        foreach ($query1 as $v) {
          ...
          //  var_dump($results);
            foreach($results as $res){
                /**
                 *   $air = $looped->air_temperature;$wet=$looped->wet_bulb;$dew=$looped->dew_temperature; 
                 * $humid=$looped->humidity;
          $direction=$looped->wind_direction; $speed=$looped->wind_speed; $actual = $looped->actual;
